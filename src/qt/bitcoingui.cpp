                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bederl Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bederl address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bederl: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBED"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bederl Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bederl Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bederl"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bederl addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bederl addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bederl: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bederl Core help message to get a list with possible Bederl command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bederl Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bederl network", "", count));
}
...
{
    QString strTitle = tr("Bederl Core"); // default title
