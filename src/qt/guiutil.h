...
/** Utility functions used by the Bederl Qt UI.
 */
namespace GUIUtil
{
...
// Render Bederl addresses in monospace font
...
// Parse "bederl:" URI into recipient object, return true on successful parsing
