...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bederl features */
        {"bederl", "masternode", &masternode, true, true, false},
        {"bederl", "listmasternodes", &listmasternodes, true, true, false},
        {"bederl", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bederl", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bederl", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bederl", "masternodedebug", &masternodedebug, true, true, false},
        {"bederl", "startmasternode", &startmasternode, true, true, false},
        {"bederl", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bederl", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bederl", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bederl", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bederl", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bederl", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bederl", "mnbudget", &mnbudget, true, true, false},
        {"bederl", "preparebudget", &preparebudget, true, true, false},
        {"bederl", "submitbudget", &submitbudget, true, true, false},
        {"bederl", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bederl", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bederl", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bederl", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bederl", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bederl", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bederl", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bederl", "checkbudgets", &checkbudgets, true, true, false},
        {"bederl", "mnsync", &mnsync, true, true, false},
        {"bederl", "spork", &spork, true, true, false},
        {"bederl", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bederl", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bederld, or the -server option to bederl-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bederl-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1: 5211/\n";
}
