...
In order to support loading of multiple wallets in bederl-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bederl.cpp.
...
Changes to bederl.cpp
----------------------
bederl.cpp is the entry point into bederl-qt, and as such, will require some minor modifications to provide hooks for
