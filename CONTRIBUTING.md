Contributing to Bederl Core
============================

The Bederl Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bederl Core project, and is not to be
confused with overall Bederl Network Protocol consensus changes.

Whether a pull request is merged into Bederl Core rests with the project merge
...
Patches that change Bederl consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bederl consensus, it must have been
...
The project leader is the release manager for each Bederl Core release.
