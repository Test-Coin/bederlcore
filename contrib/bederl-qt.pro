...
RESOURCES += src/qt/bederl.qrc src/qt/bederl_locale.qrc

TRANSLATIONS += src/qt/locale/bederl_bg.ts \
                src/qt/locale/bederl_de.ts \
                src/qt/locale/bederl_en.ts \
                src/qt/locale/bederl_es.ts \
                src/qt/locale/bederl_fi.ts \
                src/qt/locale/bederl_fr.ts \
                src/qt/locale/bederl_it.ts \
                src/qt/locale/bederl_ja.ts \
                src/qt/locale/bederl_pl.ts \
                src/qt/locale/bederl_pt.ts \
                src/qt/locale/bederl_ru.ts \
                src/qt/locale/bederl_sk.ts \
                src/qt/locale/bederl_sv.ts \
                src/qt/locale/bederl_vi.ts \
                src/qt/locale/bederl_zh_CN.ts \
                src/qt/locale/bederl_zh_TW.ts
